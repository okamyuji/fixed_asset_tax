...
export const propertiesApi = {
    ...
    create: async (data: PropertyCreateRequest, tenantId: string): Promise<Property> => {
    ...
    update: async (id: number, data: PropertyUpdateRequest, tenantId: string): Promise<Property> => {
