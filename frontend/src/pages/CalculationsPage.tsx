...
export const CalculationsPage = () => {
	const { calculationRuns, isLoading, executeCalculationRun, isExecuting } =
		useCalculations();
										...
										calculationRuns.map((run) => (
											<tr key={run.id}>
												...
												<td className="whitespace-nowrap px-3 py-4 text-sm">
													<span
														className={`inline-flex rounded-full px-2 text-xs font-semibold leading-5 ${statusColors[run.status]}`}
													>
